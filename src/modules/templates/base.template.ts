...
export const BASE_NAV: NavItem[] = [
  ...
  { label: "CRM", href: "/dashboard/crm", icon: "Users", enabled: true },
  { label: "Contactos", href: "/dashboard/crm/contacts", icon: "Contact", enabled: true },
  { label: "Facturación", href: "/dashboard/invoicing", icon: "FileText", enabled: true },
  { label: "Analytics", href: "/dashboard/analytics", icon: "BarChart3", enabled: true },
  { label: "Configuración", href: "/dashboard/settings", icon: "Settings", enabled: true },
];
